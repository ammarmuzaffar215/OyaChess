...
const Board1 = () => {
  ...
  useEffect(() => {
    if (highlight === "white") {
      applyHighlight((_, rank) => rank <= 4, "rgba(0, 0, 255, 0.3)");
    } else if (highlight === "black") {
      applyHighlight((_, rank) => rank >= 5, "rgba(0, 0, 255, 0.3)");
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-start gap-6 w-full max-w-screen-xl mx-auto p-6">
      {/* Left */}
      <div className="w-full md:w-1/2 flex flex-col items-center">
        <div className="flex flex-col items-center">
          ...
          />
          <ul className="list-disc text-left w-[400px] ml-[-50px] mt-4">
            <li className="text-lg py-1">
              There are <strong>64 squares</strong> in total.
            </li>
            <li className="text-lg py-1">
              32 <strong>light squares</strong> and 32 <strong>dark squares</strong>.
            </li>
            <li className="text-lg py-1">
