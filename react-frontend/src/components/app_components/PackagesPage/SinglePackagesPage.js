...
const SinglePackagesPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("packages")
            .get(urlParams.singlePackagesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Desc</label><p className="m-0 ml-3" >{_entity?.desc}</p></div>
