...
import seederData from "./packages.seeder.json";
...
const PackagesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PackagesSeederDialogComponent);
