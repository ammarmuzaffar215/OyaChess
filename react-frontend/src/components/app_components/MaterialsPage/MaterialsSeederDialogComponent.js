...
import seederData from "./materials.seeder.json";
...
const MaterialsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MaterialsSeederDialogComponent);
