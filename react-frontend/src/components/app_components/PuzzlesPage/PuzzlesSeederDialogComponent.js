...
import seederData from "./puzzles.seeder.json";
...
const PuzzlesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PuzzlesSeederDialogComponent);
