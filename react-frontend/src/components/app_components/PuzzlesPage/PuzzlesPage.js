    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Puzzles",
          type: "error",
          message: error.message || "Failed get Puzzles",
        });
      });
