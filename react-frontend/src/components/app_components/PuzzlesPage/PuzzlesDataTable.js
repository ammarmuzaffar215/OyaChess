    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="PuzzleId"
          body={pTemplate0}
          filter={selectedFilterFields.includes("puzzleId")}
          hidden={selectedHideFields?.includes("puzzleId")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("result")}
          hidden={selectedHideFields?.includes("result")}
          style={{ minWidth: "8rem" }}
        />
