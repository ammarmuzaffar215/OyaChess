...
const [userId, setUserId] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            .service("enrollments")
            .get(urlParams.singleEnrollmentsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const userId = Array.isArray(res.userId)
    ...
    }, [props,urlParams.singleEnrollmentsId]);
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Progress</label><p className="m-0 ml-3" >{_entity?.progress}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Schedule</label><p className="m-0 ml-3" ><Calendar id="schedule" value={_entity?.schedule?.map((d)=> new Date(d))} selectionMode="multiple"  /></p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">UserId</label>
      ...
      <CommentsSection
        recordId={urlParams.singleEnrollmentsId}
        user={props.user}
        alert={props.alert}
