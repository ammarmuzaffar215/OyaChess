...
schedule: _entity?.schedule,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info enrollments updated successfully" });
...
const userIdOptions = userId.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Enrollments" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="enrollments-edit-dialog-component">
