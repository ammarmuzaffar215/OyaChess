...
client.service("users")
    ...
    const onRun = async () => {
        let fakeData = enrollmentsFakerFactory(props.user,fakerCount,packageIdIds,userIdIds);
...
export default connect(mapState, mapDispatch)(EnrollmentsFakerDialogComponent);
