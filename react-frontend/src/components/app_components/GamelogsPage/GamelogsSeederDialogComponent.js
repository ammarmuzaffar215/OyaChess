...
import seederData from "./gamelogs.seeder.json";
...
const GamelogsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GamelogsSeederDialogComponent);
