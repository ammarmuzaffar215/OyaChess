...
const PurchasesCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      const eagerResult = await client.service("purchases").find({
        query: {
          $limit: 10000,
          _id: { $in: [_entity._id] },
          $populate: [
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info purchases updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="purchases-edit-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              ...
              onChange={(e) => setValByKey("timestamp", e.value)}
              showTime
              hourFormat="24"
            />
          </span>
