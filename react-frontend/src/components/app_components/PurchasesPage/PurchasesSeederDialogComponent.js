...
import seederData from "./purchases.seeder.json";
...
const PurchasesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PurchasesSeederDialogComponent);
