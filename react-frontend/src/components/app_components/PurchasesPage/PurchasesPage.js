    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Purchases",
          type: "error",
          message: error.message || "Failed get Purchases",
        });
      });
